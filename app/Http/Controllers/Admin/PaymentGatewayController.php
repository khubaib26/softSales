    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $gateway = PaymentGateway::create([
            ...
            'test_braintree_merchantId' => $request->test_braintree_merchantId,
            'test_braintree_publicKey' => $request->test_braintree_publicKey,
            'test_braintree_privateKey' => $request->test_braintree_privateKey,
            'live_braintree_merchantId' => $request->live_braintree_merchantId,
            'live_braintree_publicKey' => $request->live_braintree_publicKey,
            'live_braintree_privateKey' => $request->live_braintree_privateKey,
            'square_sandbox_application_id' => $request->square_sandbox_application_id,
            'square_sandbox_access_token' => $request->square_sandbox_access_token,
            'square_sandbox_location_id' => $request->square_sandbox_Location_id,
