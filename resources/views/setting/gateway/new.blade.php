                    ...
                    <form method="POST" action="{{ route('admin.gateways.store')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="row merchantBox" id="braintree" style="display:none;">
                                ...
                                <hr>
                                <div class="col-lg-4">
                                    <label for="role_name" class="mt-2">Sandbox Merchant ID</label>
                                    <input id="role_name" type="text" name="test_braintree_merchantId" value="{{ old('name') }}" placeholder="Enter Sandbox Merchant ID" class="form-control" />
                                </div>
                                <div class="col-lg-4">
                                    <label for="role_name" class="mt-2">Sandbox Public Key</label>
                                    <input id="role_name" type="text" name="test_braintree_publicKey" value="{{ old('name') }}" placeholder="Enter Sandbox Public Key" class="form-control" />
                                </div>
                                <div class="col-lg-4">
                                    <label for="role_name" class="mt-2">Sandbox Private Key</label>
                                    <input id="role_name" type="text" name="test_braintree_privateKey" value="{{ old('name') }}" placeholder="Enter Sandbox Private Key" class="form-control" />
                                </div>
                                <div class="col-lg-4">
                                    <label for="role_name" class="mt-2">Production Merchant ID</label>
                                    <input id="role_name" type="text" name="live_braintree_merchantId" value="{{ old('name') }}" placeholder="Enter Production Merchant ID" class="form-control" />
                                </div>
                                <div class="col-lg-4">
                                    <label for="role_name" class="mt-2">Production Public Key</label>
                                    <input id="role_name" type="text" name="live_braintree_publicKey" value="{{ old('name') }}" placeholder="Enter Production Public Key" class="form-control" />
                                </div>
                                <div class="col-lg-4">
                                    <label for="role_name" class="mt-2">Production Private Key</label>
                                    <input id="role_name" type="text" name="live_braintree_privateKey" value="{{ old('name') }}" placeholder="Enter ProductionPrivate Key" class="form-control" />
                                </div>
                            </div>
                            <?php /*?>
